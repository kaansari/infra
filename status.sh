...
status_line "Typesense" "8108" "http://localhost:8108"
...
status_line "MCP gateway" "$CEERAT_AGENT_GATEWAY_PORT" "http://localhost:$CEERAT_AGENT_GATEWAY_PORT/mcp"
status_line "Keycloak" "$CEERAT_KEYCLOAK_PORT" "http://localhost:$CEERAT_KEYCLOAK_PORT/realms/ceerat"
