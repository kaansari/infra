...
| 3B | [Database lifecycle](03b-database-lifecycle.md) | `services-repo`, `infra` | Implemented locally; deterministic empty bootstrap, checksum ledger, migration lock, complete preflight, and restore runbook |
